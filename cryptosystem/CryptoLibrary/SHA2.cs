...
namespace CryptoLibrary
{
    ...
    public class SHA2 : ICryptoLibrary
    {
        ...
        public SHA2(byte[] key, byte[] iv, IDictionary<string, byte[]> specArguments)
        {
            this.Key = key;
            this.Iv = iv;
        ...
        public byte[] Crypt(byte[] input)
        {
            ...
            string strHash = SHA256(strInput);
            return Encoding.Unicode.GetBytes(strHash);
        }

        public byte[] Decrypt(byte[] output)
        {
            return Encoding.Unicode.GetBytes("Dekriptovanje nije moguce!");
        }
    ...
    0x748f82ee,0x78a5636f,0x84c87814,0x8cc70208,0x90befffa,0xa4506ceb,0xbef9a3f7,0xc67178f2
        ...
        public static string SHA256(string data)
        {
            ...
            SHA256Init(ref ctx);
            SHA256Update(ref ctx, Encoding.Unicode.GetBytes(data), (uint)data.Length);
